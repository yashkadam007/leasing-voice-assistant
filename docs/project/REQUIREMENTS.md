...
- M07 does not yet satisfy voice, confirmation-gated prospect capture, prospect writes, model-backed natural-language generation, or demo-recording requirements; those remain assigned to later milestones.
