...
- M07 provides concrete evidence for FR-02, FR-03, FR-04, FR-05, FR-10, EVAL-02, EVAL-03, NFR-03, and NFR-06: deterministic text-turn orchestration, database-vs-KB route classification, updated property-resolution state, inspectable database evidence and KB snippets, DB rent-answer tests, KB application-process tests, unknown fallback tests, missing-property clarification tests, ambiguous-property clarification tests, prior-context unit-answer tests, and DB precedence for structured pet-policy facts.
- M08 provides concrete evidence for FR-06, FR-07, FR-08, FR-09, FR-10, EVAL-03, NFR-03, and NFR-06: deterministic prospect-capture state, explicit write-gate outcomes, missing-name tests, missing-phone tests, ambiguous-property write blocking, unclear-intent confirmation, low-confidence/garbled transcript confirmation, explicit confirmation writes, unit-level interest writes, caller-phone upsert behavior, duplicate interest idempotency, and pending-confirmation invalidation when critical details change.
- M09 provides concrete evidence for FR-02, FR-03, FR-04, FR-05, FR-06, FR-07, FR-08, FR-09, FR-10, EVAL-02, EVAL-03, NFR-03, and NFR-06: reusable in-memory session state, transcript recording, multi-turn property context tests, complete text prospect-capture flow tests, confirmation-required flow tests, ambiguous-property blocked-write tests, safe debug traces, and a local CLI harness over the same session service.
- M09 does not yet satisfy voice, model-backed natural-language generation, browser/telephony integration, or demo-recording requirements; those remain assigned to later milestones.
