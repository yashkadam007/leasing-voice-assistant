...
- M08 does not yet satisfy voice, text conversation harness, model-backed natural-language generation, or demo-recording requirements; those remain assigned to later milestones.
