...
| [0013](0013-deepgram-text-to-speech-for-twilio-playback.md) | Deepgram Text To Speech For Twilio Playback | Accepted | TTS hardening | Selects Deepgram Aura TTS with raw 8 kHz mu-law output for Twilio playback after ElevenLabs `ulaw_8000` returned a paid-plan error. |
